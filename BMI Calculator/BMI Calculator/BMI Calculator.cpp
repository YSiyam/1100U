...
int main()
{
	...
	int heighti, heightf; //this is the total height used in the bmi calculation
						  ...
						  //the two commands below enable the use of decimals, without them cout won't display decimals
	...
	else if (bmi <= 18.5) //this is the underweight BMI statement
	{
		std::cout << "You are underweight \n";
	}

	else if ((bmi >= 25) && (bmi <= 29.9)) //this is the overweight BMI statement
	{
		std::cout << "you are overweight! \n";
	}

	else if (bmi >= 30) //this is the obese BMI statement
	{
